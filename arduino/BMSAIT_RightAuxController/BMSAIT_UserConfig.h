...
//BASIC SETTINGS
  ...
  const char ID[]= "BMSAIT_RightAuxController"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
  ...
  Datenfeld datenfeld[]=
    {
	  ...
	  {"In3D",   "1651",  'b',  99,    0,   0,   0,   0,  0,   0}       	//Variable 0 - Player is in 3D
	  ,{"Fly",    "1478",  'b',  99,    0,   0,   0,   0,  0,   0}			//Variable 1 - Player is in Aircraft
	  // Servos
