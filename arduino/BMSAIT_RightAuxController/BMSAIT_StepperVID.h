...
StepperdataVID stepperdataVID[] =
{
  //  {PIN Step PIN Dir}     arc    inverted   last
    { {    A0,      A1   },   315*12 ,  false,     0   },  // EPU FUEL
	{ {    A2,      A3   },   315*12 ,  false,     0   },  // CABIN PRESS
	{ {    A4,      A5   },   315*12 ,  false,     0   }  // COMPASS
};
...
{
   SwitecX12(69,0,0), SwitecX12(69,0,0), SwitecX12(69,0,0)  //dummy call
}; 
