...
Switch schalter[]=
{
	//{ PNEUPIN,     "PNEU",     2,         0,            0,           "03",                     "04",                   0}          
//  <PIN>,<description>,<type 1-button, 2-switch, 3-rotary>,<rotarySwitchID>,  0, <commandID when pressed>,<commandID when released>,<internal command> 
   /* { 0,     "MC",       1,         0,            0,           "01",                     "00",                   0}          //Example button (Master Caution pushbutton) on PIN 2
